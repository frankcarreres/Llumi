...
import DefaultNavbarMobile from "admin/widgets/Navbars/DefaultNavbar/DefaultNavbarMobile";
...
function DefaultNavbar({ transparent, light, action }) {
  ...
  return (
    <Container>
      ...
      {mobileView && (
        <DefaultNavbarMobile open={mobileNavbar} close={closeMobileNavbar} routes={adminRoutes} />
      )}
    </Container>
  );
}
